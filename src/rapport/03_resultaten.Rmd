...
benthos_afdw %>%
  filter(real_X == 0)
# uit mail Frank: DG18_23 is een bestaand benthosstaal (zie benthosdata -niet weggevallen of verlegd dus) in matig diep subtidaal genomen. 
```
...
# enkel Zeeschelde, Rupel en Durme / geen raaien
