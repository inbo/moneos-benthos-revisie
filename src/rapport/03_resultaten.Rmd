...
```{r plot-salzone, fig.width=7, fig.height=4, fig.cap = "(ref:plot-salzone)"}
...
```{r hoogteligging-survey, fig.width=6, fig.height=5, fig.cap = "(ref:hoogteligging-survey)"}
...
```{r plot-ruwe-data, fig.width=6, fig.height=6, fig.cap = "(ref:plot-ruwe-data)", warning=FALSE}
benthos_afdw_zs_durme_rupel %>%
  filter(tidaal != "subtidaal") %>%
  rename(ecotoop_werkelijk = ecotoop_werkelijk.benthos) %>%
  st_drop_geometry() %>%
  ...
  scale_color_discrete(name = "werkelijk \n ecotoop", 
...
Dit is bijvoorbeeld het geval in de zoete delen met korte verblijftijd, met name voor de middelhoge slikzone, maar ook voor de lage en de hoge slikzone en meer uitgesproken in 2019.
...
```{r schattingen-raaispatial-ecotoop, fig.height = 200/25.4, fig.width=5,  fig.cap = "(ref:schattingen-raaispatial-ecotoop)"}
