...
Het MONEOS langetermijn monitoring- en onderzoeksprogramma heeft als belangrijkste doelstelling om grensoverschrijdende samenwerking over het beheer en beleid rond het Schelde estuarium en zijn getijderivieren te ondersteunen.
Dit programma stemde reeds bestaande programma’s op elkaar af en vulde ze aan tot een geïntegreerd en samenhangend geheel zoals staat beschreven in @meire2008.
Het resultaat is een breed programma waarbij sinds 2008 zowel fysisch-chemische als biologische variabelen worden ingezameld en onderzocht.
Binnen de biologische variabelen kijkt men onder meer naar het macrozoöbenthos (MZB) [@speybroeck2014].
De macrozoöbenthos gegevens voor de Zeeschelde worden niet alleen gebruikt voor de beoordeling van de draagkracht en het ecologisch functioneren van het Zeeschelde-estuarium, maar ook voor beoordelingen voor de Europese Kaderrichtlijn Water.
...
De jaarlijkse campagne houdt rekening met grote verschillen in fysiotopen langsheen het waterlichaam en moet een representatief beeld geven van de toestand in een bepaald jaar.
...
Deze vaste locaties langsheen raaien laten in principe beter toe om een antwoord te geven op vragen zoals "Welke effecten hebben sedimenthoogteveranderingen (vb. door verdieping van de Schelde) op de samenstelling en densiteit van MZB?".
Deze raaien zijn gericht gekozen in de ecologisch interessantste gebieden met een intakte slibplaat.
Deze nieuwe manier van bemonsteren vormt een terugkeer naar de manier van werken van vóór 2008, waar er ook met vaste raaien werd gewerkt [@speybroeck2014].
...
-   Voor het stratified random sample moeten veel ecologisch gezien oninteressante gebieden meegenomen worden, waar vogels nauwelijks of niet foerageren (MZB als voedselbron). Zijn deze gebieden dan nodig voor de berekening van de draagkracht van de rivier? Het resultaat van deze oefening moet weliswaar nog steeds voldoen aan de eisen voor de berekening van de ecologische kwaliteit in functie van de KRW. Daarbij dient een oordeel geveld over een aantal verschillende waterlichamen (Zeeschelde I tot IV, getijdeDurme, Getijdededijle en getijdezenne en getijdenetes).
