...
\sigma^2_{BF} &= \frac{\sigma^2_B}{nS}(1-f_B)\\
...
De term $\sigma^2_B$ stelt de bemonsteringsfout voor bij een eenheid van de bemonsteringsinspanning ($S = 1$) op één locatie uit de $n$ mogelijke locaties van de steekproef.
