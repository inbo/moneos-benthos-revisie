...
srv_data <- # data.frame maken met alle survey design variabele en responsvariabelen

mzb_strata <- srv_data %>%
  as_survey_design(strata = ,
                   weights = )


# https://cran.r-project.org/web/packages/srvyr/vignettes/srvyr-vs-survey.html
# Horvitz-Thomson type schatters (eventueel eerst sqrt-transformeren; of log, maar nullen)
mzb_strata %>%
  #group_by(...) %>%
  summarize(mzb_tot = survey_total(x = , na.rm = TRUE,
