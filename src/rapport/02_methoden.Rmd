...
Voor de raaigegevens is het verleidelijk om ook de identiteit van de afzonderlijke raaien en de individuele locaties (genest in raaien) in de analyse te betrekken als een random intercepten.
